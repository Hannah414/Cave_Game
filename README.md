...
First 4 levels of game separated out
Added ladder to mark end of level 
Each level had endpoint that transports player to next level 

## Week 16 - 1/22/24

All levels are separated
Levels all have ladders that transfer player to next level 
All levels work correctly as they did before split 
Fixed goblin so he actually attacks when in range 
Added colliders to puddles in first level (forgot them last week lol)
Waiting to add fade as I would need to add a overlay to all scene which could cause issues when working 

## Week 17 - 1/29/24

Have a health bar that can go up and down
Have script for health bar to go up and down
Health bar will start correctly
Enemies somehow not working now (T-T)
Health bar will change if I force damage on player
...
Made universal health variable 
Had weird error where health bar no longer works past level 1

## Week 20 - 2/19/24

FIXED ERROR
Added code for health and healthbar to all levels 
Redid level 4 (lava room) 
Score increases when looting crates or killing mobs 

## Week 21 - 2/26/24

Score displays correctly when starting 
Score display goes up when player earns points
...
Made dialogue for Hermin(NPC)
Decided Hermin(NPC) is blind
Made Hermin’s(NPC) level a maze 

## Week 23 - 3/18/24

Change dialogue to cutscene
Added decorations to level
Made it myself!!
Should I add slimes?
Changed appearance of Hermin’s headshot
Basic outline for script
Script is working!

## Week 24 - 3/25/24

Reworked final page to display score
Added fade to all levels 
Made list of goals for remainder of semester
Added enemies to Hermin’s level 

## Week 25 - 4/1/24

Added buttons to all display screens
Death, Start, End 
Created code to control buttons

## Week 26 - 4/8/24

Added in dialogue to Hermin
Finally updated GitHub for project 

## Week 27 - 4/15/24

Added in health potions
When used, adds 5 points back to health
Number of potions displayed in top right corner

## Week 28 - 4/22/24

Made starting/restart screen accessable in all levels 
Added Hermin's(NPC) dialogue into game
Added slimes into Hermin's(NPC) level 

## Week 29 - 4/29/24

Added Death Screen (similar to start screen, but different display)
Added shadow fade to edges of screen for darkness effect
